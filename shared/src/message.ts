 ...
 *              (fresh export inserted); afterwards it joins the random
 *              rotation. At most one item per card is the intro — the studio
 *              enforces this and exports it as config.json `intro_index`.
 */
